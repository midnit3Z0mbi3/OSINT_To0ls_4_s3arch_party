...
apt install ruby-dev nmap wireshark tcpdump ufw postgresql git golang python3-venv pipx httrack webhttrack filezilla mysql-client qtox hexchat gajim audacity gimp inkscape librecad -y
